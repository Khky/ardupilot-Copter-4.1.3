...
const AP_Param::Info Copter::var_info[] = {
    ...
    // @Increment: 1
    // @User: Standard
    GSCALAR(rtl_altitude,   "RTL_ALT",     1500),
    ...
    // @User: Standard
    GSCALAR(rtl_cone_slope,   "RTL_CONE_SLOPE",     3),
    ...
    // @Increment: 1
    // @User: Standard
    GSCALAR(rtl_alt_final,  "RTL_ALT_FINAL", 0),
    ...
    // @Increment: 10
    // @User: Standard
    GSCALAR(rtl_climb_min,  "RTL_CLIMB_MIN",    0),
    ...
    // @Increment: 1000
    // @User: Standard
    GSCALAR(rtl_loiter_time,      "RTL_LOIT_TIME",    2000),
    ...
    // @User: Standard
    GSCALAR(wp_yaw_behavior,  "WP_YAW_BEHAVIOR",   1),
    ...
    // @Increment: 10
    // @User: Standard
    GSCALAR(pilot_speed_up,     "PILOT_SPEED_UP",   500),
    ...
    // @Increment: 10
    // @User: Standard
    GSCALAR(pilot_accel_z,  "PILOT_ACCEL_Z",    800),
    ...
    // @User: Standard
    GSCALAR(failsafe_throttle,  "FS_THR_ENABLE",   1),
    ...
    // @Increment: 1
    // @User: Standard
    GSCALAR(failsafe_throttle_value, "FS_THR_VALUE",  960),
    ...
    // @User: Standard
    GSCALAR(flight_mode1, "FLTMODE1",          16),
    ...
    // @Values: 0:Stabilize,1:Acro,2:AltHold,3:Auto,4:Guided,5:Loiter,6:RTL,7:Circle,9:Land,11:Drift,13:Sport,14:Flip,15:AutoTune,16:PosHold,17:Brake,18:Throw,19:Avoid_ADSB,20:Guided_NoGPS,21:Smart_RTL,22:FlowHold,23:Follow,24:ZigZag,25:SystemID,26:Heli_Autorotate
    // @User: Standard
    GSCALAR(flight_mode2, "FLTMODE2",               16),
    ...
    // @Values: 0:Stabilize,1:Acro,2:AltHold,3:Auto,4:Guided,5:Loiter,6:RTL,7:Circle,9:Land,11:Drift,13:Sport,14:Flip,15:AutoTune,16:PosHold,17:Brake,18:Throw,19:Avoid_ADSB,20:Guided_NoGPS,21:Smart_RTL,22:FlowHold,23:Follow,24:ZigZag,25:SystemID,26:Heli_Autorotate
    // @User: Standard
    GSCALAR(flight_mode3, "FLTMODE3",             16,
    ...
    // @Values: 0:Stabilize,1:Acro,2:AltHold,3:Auto,4:Guided,5:Loiter,6:RTL,7:Circle,9:Land,11:Drift,13:Sport,14:Flip,15:AutoTune,16:PosHold,17:Brake,18:Throw,19:Avoid_ADSB,20:Guided_NoGPS,21:Smart_RTL,22:FlowHold,23:Follow,24:ZigZag,25:SystemID,26:Heli_Autorotate
    // @User: Standard
    GSCALAR(flight_mode4, "FLTMODE4",               5),
    ...
    // @Values: 0:Stabilize,1:Acro,2:AltHold,3:Auto,4:Guided,5:Loiter,6:RTL,7:Circle,9:Land,11:Drift,13:Sport,14:Flip,15:AutoTune,16:PosHold,17:Brake,18:Throw,19:Avoid_ADSB,20:Guided_NoGPS,21:Smart_RTL,22:FlowHold,23:Follow,24:ZigZag,25:SystemID,26:Heli_Autorotate
    // @User: Standard
    GSCALAR(flight_mode5, "FLTMODE5",          0),
    ...
    // @Values: 0:Stabilize,1:Acro,2:AltHold,3:Auto,4:Guided,5:Loiter,6:RTL,7:Circle,9:Land,11:Drift,13:Sport,14:Flip,15:AutoTune,16:PosHold,17:Brake,18:Throw,19:Avoid_ADSB,20:Guided_NoGPS,21:Smart_RTL,22:FlowHold,23:Follow,24:ZigZag,25:SystemID,26:Heli_Autorotate
    // @User: Standard
    GSCALAR(flight_mode6, "FLTMODE6",            6),
    ...
    // @User: Advanced
    GSCALAR(flight_mode_chan, "FLTMODE_CH",         8),
    ...
    // @Range: 1000 5600
    // @User: Advanced
    ASCALAR(angle_max, "ANGLE_MAX",                5600 ),
    ...
    // @Range: 4 12
    // @User: Advanced
    GSCALAR(poshold_brake_rate, "PHLD_BRAKE_RATE",  8),
    ...
    // @Range: 2000 4500
    // @User: Advanced
    GSCALAR(poshold_brake_angle_max, "PHLD_BRAKE_ANGLE",  2000),
#endif
...
const AP_Param::GroupInfo ParametersG2::var_info[] = {
    ...
    // @Increment: 10
    // @User: Standard
    AP_GROUPINFO("PILOT_SPEED_DN", 24, ParametersG2, pilot_speed_dn, 200),
    ...
    // @User: Advanced
    AP_GROUPINFO("RTL_OPTIONS", 0, ParametersG2, rtl_options, 0),
#endif
    ...
    // @User: Advanced
    AP_GROUPINFO("FLIGHT_OPTIONS", 0, ParametersG2, flight_options, 0),
...
const AP_Param::ConversionInfo conversion_table[] = {
    ...
    { Parameters::k_param_serial0_baud,       115,      AP_PARAM_INT16, "SERIAL0_BAUD" },
    { Parameters::k_param_serial1_baud,       57,      AP_PARAM_INT16, "SERIAL1_BAUD" },
    { Parameters::k_param_serial2_baud,       57,      AP_PARAM_INT16, "SERIAL2_BAUD" },
...
void Copter::convert_pid_parameters(void)
{
    ...
    const AP_Param::ConversionInfo pid_conversion_info[] = {
        { Parameters::k_param_pid_rate_roll, 0.1, AP_PARAM_FLOAT, "ATC_RAT_RLL_P" },
        { Parameters::k_param_pid_rate_roll, 0.1, AP_PARAM_FLOAT, "ATC_RAT_RLL_I" },
        { Parameters::k_param_pid_rate_roll, 0.001, AP_PARAM_FLOAT, "ATC_RAT_RLL_D" },
        { Parameters::k_param_pid_rate_pitch, 0.1 AP_PARAM_FLOAT, "ATC_RAT_PIT_P" },
        { Parameters::k_param_pid_rate_pitch, 1, AP_PARAM_FLOAT, "ATC_RAT_PIT_I" },
        { Parameters::k_param_pid_rate_pitch, 0.001, AP_PARAM_FLOAT, "ATC_RAT_PIT_D" },
        { Parameters::k_param_pid_rate_yaw, 0.25, AP_PARAM_FLOAT, "ATC_RAT_YAW_P" },
        { Parameters::k_param_pid_rate_yaw, 0.2, AP_PARAM_FLOAT, "ATC_RAT_YAW_I" },
        { Parameters::k_param_pid_rate_yaw, 0, AP_PARAM_FLOAT, "ATC_RAT_YAW_D" },
#if FRAME_CONFIG == HELI_FRAME
    ...
    const AP_Param::ConversionInfo imax_conversion_info[] = {
        { Parameters::k_param_pid_rate_roll,  0.5, AP_PARAM_FLOAT, "ATC_RAT_RLL_IMAX" },
        { Parameters::k_param_pid_rate_pitch, 0.5, AP_PARAM_FLOAT, "ATC_RAT_PIT_IMAX" },
    ...
    const AP_Param::ConversionInfo angle_and_filt_conversion_info[] = {
        { Parameters::k_param_p_stabilize_roll, 10, AP_PARAM_FLOAT, "ATC_ANG_RLL_P" },
        { Parameters::k_param_p_stabilize_pitch, 10, AP_PARAM_FLOAT, "ATC_ANG_PIT_P" },
        { Parameters::k_param_p_stabilize_yaw, 13, AP_PARAM_FLOAT, "ATC_ANG_YAW_P" },
        ...
        { Parameters::k_param_pi_vel_xy, 1, AP_PARAM_FLOAT, "PSC_VELXY_P" },
        { Parameters::k_param_pi_vel_xy, 0, AP_PARAM_FLOAT, "PSC_VELXY_I" },
        { Parameters::k_param_pi_vel_xy, 500, AP_PARAM_FLOAT, "PSC_VELXY_IMAX" },
        { Parameters::k_param_pi_vel_xy, 5, AP_PARAM_FLOAT, "PSC_VELXY_FLTE" },
        { Parameters::k_param_p_vel_z, 2, AP_PARAM_FLOAT, "PSC_VELZ_P" },
        { Parameters::k_param_pid_accel_z, 0.2, AP_PARAM_FLOAT, "PSC_ACCZ_P" },
        { Parameters::k_param_pid_accel_z, 0.75, AP_PARAM_FLOAT, "PSC_ACCZ_I" },
        { Parameters::k_param_pid_accel_z, 0, AP_PARAM_FLOAT, "PSC_ACCZ_D" },
        { Parameters::k_param_pid_accel_z, 1000, AP_PARAM_FLOAT, "PSC_ACCZ_IMAX" },
        { Parameters::k_param_pid_accel_z, 20, AP_PARAM_FLOAT, "PSC_ACCZ_FLTE" },
        { Parameters::k_param_p_alt_hold, 0.25, AP_PARAM_FLOAT, "PSC_POSZ_P" },
        { Parameters::k_param_p_pos_xy, 2, AP_PARAM_FLOAT, "PSC_POSXY_P" },
    };
    ...
    const AP_Param::ConversionInfo loiter_conversion_info[] = {
        { Parameters::k_param_wp_nav, 1400, AP_PARAM_FLOAT, "LOIT_SPEED" },
        { Parameters::k_param_wp_nav, 500, AP_PARAM_FLOAT, "LOIT_BRK_JERK" },
        { Parameters::k_param_wp_nav, 500, AP_PARAM_FLOAT, "LOIT_ACC_MAX" },
        { Parameters::k_param_wp_nav, 250, AP_PARAM_FLOAT, "LOIT_BRK_ACCEL" }
    };
    ...
    static const struct AP_Param::defaults_table_struct heli_defaults_table[] = {
        { "LOIT_ACC_MAX", 500.0f },
        { "LOIT_BRK_ACCEL", 250.0f },
        { "LOIT_BRK_DELAY", 0.0f },
        { "LOIT_BRK_JERK", 500.0f },
        { "LOIT_SPEED", 1400.0f },
        { "PHLD_BRAKE_ANGLE", 2000.0f },
        { "PHLD_BRAKE_RATE", 8.0f },
        { "PSC_ACCZ_P", 0.2f },
        { "PSC_VELXY_D", 0.01f },
        { "PSC_VELXY_I", 0.1f },
        { "PSC_VELXY_P", 1.0f },
    ...
    const AP_Param::ConversionInfo ff_and_filt_conversion_info[] = {
        ...
        { Parameters::k_param_attitude_control, 40, AP_PARAM_FLOAT, "ATC_RAT_RLL_FLTD" },
        { Parameters::k_param_attitude_control, 40, AP_PARAM_FLOAT, "ATC_RAT_RLL_FLTT" },
        { Parameters::k_param_attitude_control, 40, AP_PARAM_FLOAT, "ATC_RAT_PIT_FLTD" },
        { Parameters::k_param_attitude_control, 40, AP_PARAM_FLOAT, "ATC_RAT_PIT_FLTT" },
        { Parameters::k_param_attitude_control, 4.5, AP_PARAM_FLOAT, "ATC_RAT_YAW_FLTE" },
        { Parameters::k_param_attitude_control, 0, AP_PARAM_FLOAT, "ATC_RAT_RLL_FF" },
        { Parameters::k_param_attitude_control, 0, AP_PARAM_FLOAT, "ATC_RAT_PIT_FF" },
        { Parameters::k_param_attitude_control, 0, AP_PARAM_FLOAT, "ATC_RAT_YAW_FF" },
#endif
